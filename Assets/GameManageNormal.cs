    ...
    void Update()
    {
        ...
        if (isRun)
        {
            ...
            if (timeRecent2 > beat)
            {
                ...
                for (int j = 0; j < n; j++)
                {
                    if (dots[0, j, time].GetComponent<DotManage>().isAlive)
                    {
                        counter[0]++;
                    }

                    if (dots[1, j, time].GetComponent<DotManage>().isAlive)
                    {
                        counter[1]++;
                    }

                    if (dots[2, j, time].GetComponent<DotManage>().isAlive)
                    {
                        counter[2]++;
                    }

                    if (dots[3, j, time].GetComponent<DotManage>().isAlive)
                    {
                        counter[3]++;
                    }

                    if (dots[4, j, time].GetComponent<DotManage>().isAlive)
                    {
                        counter[4]++;
                    }

                    if (dots[5, j, time].GetComponent<DotManage>().isAlive)
                    {
                        counter[5]++;
                    }

                    if (dots[6, j, time].GetComponent<DotManage>().isAlive)
                    {
                        counter[6]++;
                    }

                    if (dots[7, j, time].GetComponent<DotManage>().isAlive)
                    {
                        counter[7]++;
                    }
